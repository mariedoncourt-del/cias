...
class Task extends BaseController
{
     ...
     */
     ...
     public function afficher_taches()
     {
        print_r($this->tm->afficher_taches());
     }
    ...
    function taskListing()
    {
        ...
        {        
			...
			$returns = $this->paginationCompress ( "taskListing/", $count, 20000 );
            
            $data['records'] = $this->tm->taskListing($searchText, $returns["page"], $returns["segment"]);
            
            $this->global['pageTitle'] = 'Maf Facturation : Tâche';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'Ajouter une nouvelle tâche';
    ...
    function addNewTask()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if($result > 0) {
                    $this->session->set_flashdata('success', 'Nouvelle tâche créée avec succès');
                } else {
                    $this->session->set_flashdata('error', 'La création de la tâche a échoué');
                }
    ...
    function addNewTasks()
    {
        ...
        else
        {
            ...
            {
                $taskTitle = "Suppression Stagiaire";
                $description = "Suppression Stagiaire";
    ...
    function edit($taskId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'CodeInsect : Modifier la tâche';
    ...
    {
        $this->tm->deleteTask($this->input->post("taskid"));
    ...
    function editTask()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if($result == true)
                {
                    $this->session->set_flashdata('success', 'Tâche mise à jour avec succès');
                }
                else
                {
                    $this->session->set_flashdata('error', 'La mise à jour de la tâche a échoué');
                }

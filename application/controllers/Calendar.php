	...
	public function index() 
	{
		...
		foreach ($data_calendar as $key => $val) 
		{
			$calendar[] = array(
							...
							'nom_formateur' => $val->nom_formateur, 
							'prenom_formateur' => trim($val->prenom_formateur), 
							'date_debut' => date_format( date_create($val->date_debut) ,"Y-m-d H:i:s"),
							'date_fin' 	=> date_format( date_create($val->date_fin) ,"Y-m-d H:i:s"),
							//'color' => $val->color,
							);
		}
      ...
      // $data['donnee'] = $this->table->recuperer();
        ...
        $this->loadViews("stagiaire/calendar", $this->global, $data , NULL);
        
		//$this->load->view('stagiaire/calendar', $data);
	}

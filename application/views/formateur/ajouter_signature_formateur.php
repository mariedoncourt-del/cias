    ...
    <section style="background-color:#ffffff" class="content">
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <div class="card-body">
               <?php echo form_open_multipart('formateur/prosesUploadSignature'); ?>
               <div class="col-lg-12">
                      <div class="input-group">
                          <input type="text" name="nom_formateur" id="nom_formateur" class="form-control" placeholder="Nom formateur">
                    </div>
                </div>
                <div class="col-lg-12">
                      <div class="input-group">
                          <input type="text" name="prenom_formateur" id="prenom_formateur" class="form-control" placeholder="Nom formateur">
                    </div>
                </div>
                ...
                <input type="submit" class="btn btn-success" value="Charger">

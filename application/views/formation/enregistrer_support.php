    ...
    <section style="background-color:#ffffff" class="content">
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <div class="card-body">
               <?= form_open_multipart('formation/enregistrerSupports'); ?>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-lg-12">
                      <div class="input-group">
                          <input type="text" name="nom_support" id="nom_support" class="form-control" placeholder="Nom support">
                     </div>
                  </div>
                  <div class="col-lg-12">
                      <div class="input-group">
                        <select name="categorie" id="categorie" class="form-control">
                                ...
                                <option value="RESEAU SOCIAUX">RESEAU SOCIAUX</option>
                   ...
                   <div class="col-lg-10"><input type="file" name="fichier"></div>
                    </div>
                    <div class="form-group row">
                    <div class="col-lg-4"><input type="submit" class="btn btn-success" value="Ajouter"></div>
...
<div class="modal" id="monModal3">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo site_url('formation/download_archive_certificat'); ?>">
...
$(document).ready(function(){
  ...
  $('#btn_telechargers').click(function(){
   ...
   var form_data = {
    ...
    $.ajax({
        url: "<?php echo site_url('formation/download_archive_formulaire'); ?>",
        type: 'GET',
        data: form_data,
        success: function(data) {
           // $('#result_tableau').html(data);
  ...
  $('#nom_programme').autocomplete({
          ...
          source: "<?php echo site_url('formation/get_autocomplete_archive_formulaire'); ?>",
  ...
  $('#supprimer').click(function(){
   ...
   var form_data = {
    ...
    $.ajax({
        url: "<?php echo site_url('formation/supprimer_archive_facture'); ?>",
        type: 'POST',
        data: form_data,
        success: function(data) {
           // $('#result_tableau').html(data);
...
$(document).on('click','.btn_telecharger',function(){
 ...
 $('#btn_nouveau').click(function(){
  ...
  function load_data()
    {
      $.ajax({
        url: "<?php echo site_url('formation/liste_support'); ?>",
        type: 'POST',
        success: function(data) {
    ...
    function load_data_recherche($nom)
    {
      ...
      $.ajax({
        url: "<?php echo site_url('formation/liste_archive_factures'); ?>",
        type: 'POST',

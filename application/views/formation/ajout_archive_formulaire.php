            ...
            <div class="col-md-12">
              <div class="card text-center">
                  <div class="card-header btn-primary">
                        Enregistrement Archive Dossier AGEFICE
                  </div>
             <div class="card-body">
               <?= form_open_multipart('formation/prosesUploadFormulaire'); ?>
...
$(document).ready(function(){
  ...
  $('#supprimer').click(function(){
   ...
   var form_data = {
    ...
    $.ajax({
        url: "<?php echo site_url('formation/supprimer_archive_formulaire'); ?>",
        type: 'POST',
        data: form_data,
        success: function(data) {
           // $('#result_tableau').html(data);
...
$(document).on('click','.btn_telecharger',function(){
 ...
 $('#btn_nouveau').click(function(){
  ...
  function load_data()
    {
      $.ajax({
        url: "<?php echo site_url('formation/liste_archive_formulaire'); ?>",
        type: 'POST',
        success: function(data) {
    ...
    function load_data_recherche($nom)
    {
      ...
      $.ajax({
        url: "<?php echo site_url('formation/liste_archive_formulaires'); ?>",
        type: 'POST',

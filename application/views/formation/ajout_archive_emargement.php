            ...
            <div class="col-md-12">
              <div class="card text-center">
                  <div class="card-header btn-primary">
                        Enregistrement Archive Emargement
                  </div>
             <div class="card-body">
               <?= form_open_multipart('formation/prosesUploadEmargement'); ?>
...
<div class="modal" id="monModal3">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="<?php echo site_url('formation/download_archive_emargement'); ?>">
...
$(document).ready(function(){
  ...
  $('#btn_telechargers').click(function(){
   ...
   var form_data = {
    ...
    $.ajax({
        url: "<?php echo site_url('formation/download_archive_emargement'); ?>",
        type: 'GET',
        data: form_data,
        success: function(data) {
           // $('#result_tableau').html(data);
  ...
  $('#supprimer').click(function(){
   ...
   var form_data = {
    ...
    $.ajax({
        url: "<?php echo site_url('formation/supprimer_archive_emargement'); ?>",
        type: 'POST',
        data: form_data,
        success: function(data) {
           // $('#result_tableau').html(data);
...
$(document).on('click','.btn_telecharger',function(){
 ...
 $('#btn_nouveau').click(function(){
  ...
  function load_data()
    {
      $.ajax({
        url: "<?php echo site_url('formation/liste_archive_emargement'); ?>",
        type: 'POST',
        success: function(data) {
    ...
    function load_data_recherche($nom)
    {
      ...
      $.ajax({
        url: "<?php echo site_url('formation/liste_archive_emargements'); ?>",
        type: 'POST',

                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'booking/edit/'.$record->bookingId; ?>" title="Voir ou Modifier le dossier"><i class="fa fa-pencil"></i></a>
                            <a class="btn btn-sm btn-danger deleteBooking" href="#" data-bookingid="<?php echo $record->bookingId; ?>" title="Supprimer le dossier"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
